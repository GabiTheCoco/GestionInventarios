													...
													void mostrar_busquedaCoincidentes(bool& ingresoValido){
														...
														void buscarPorNombre(vector<Producto>productos){
															...
															if(entradaValida){
																...
																cout<<endl<<setw(6)<<" "<<"Lista de "<<nombre<<endl<<endl
															...
															void buscarPorRangoPrecios(vector<Producto> productos){
																...
																if(entradaValida1 && entradaValida2){
																	...
																	if (archivo.is_open()) {
																		archivo<<endl<<setw(6)<<" "<<"Lista de productos entre "<<precioMin<<" y "<<precioMax<<endl<<endl
																			<<setw(6)<<" "<<"ID"<<setw(10)<<" "<<"Nombre"<<setw(10)<<" "
																			<<"Precio"<<setw(10)<<" "<<"Stock"<<setw(10)<<" "
																			<<"Categoria"<<setw(10)<<" "<<"Marca"<<setw(10)<<" "<<endl<<endl;
																		...
																		for(int i=0;i<productosPrecios.size();i++){
																			...
																			archivo<<setw(6)<<" "<<productosPrecios[i].idProducto<<setw(10)<<" "<<productosPrecios[i].nombreProducto
																...
																void buscarPorCategoria(vector<Producto> productos){
																	...
																	if(entradaValida){
																		...
																		if (archivo.is_open()) {
																			archivo<<endl<<setw(6)<<" "<<"Lista de productos  "<<categ<<endl<<endl
																				<<setw(6)<<" "<<"ID"<<setw(10)<<" "<<"Nombre"<<setw(10)<<" "
																				<<"Precio"<<setw(10)<<" "<<"Stock"<<setw(10)<<" "
																				<<"Categoria"<<setw(10)<<" "<<"Marca"<<setw(10)<<" "<<endl<<endl;
																			...
																			for(int i=0;i<productosCategorias.size();i++){
																				...
																				archivo<<setw(6)<<" "<<productosCategorias[i].idProducto<<setw(10)<<" "<<productosCategorias[i].nombreProducto
																	...
																	void buscarPorMarca(vector<Producto>productos){
																		...
																		if(entradaValida){
																			...
																			if (archivo.is_open()) {
																				archivo<<endl<<setw(6)<<" "<<"Lista de productos  "<<marc<<endl<<endl
																					<<setw(6)<<" "<<"ID"<<setw(10)<<" "<<"Nombre"<<setw(10)<<" "
																					<<"Precio"<<setw(10)<<" "<<"Stock"<<setw(10)<<" "
																					<<"Categoria"<<setw(10)<<" "<<"Marca"<<setw(10)<<" "<<endl<<endl;
																				...
																				for(int i=0;i<productosMarcas.size();i++){
																					...
																					archivo<<setw(6)<<" "<<productosMarcas[i].idProducto<<setw(10)<<" "<<productosMarcas[i].nombreProducto
